...
const PagamentoSection = () => {
    ...
    const handleCopyToClipboard = () => {
        const pixKey = "00020126430014br.gov.bcb.pix0114+55489996940840203Pix5204000053039865406197.005802BR5917GERUSA LORENZETTI6013FLORIANOPOLIS62150511Despertar4063044D9C";
            ...
            <div className="flex flex-col justify-center items-center">
                ...
                {pixClicked && (
                    <div className="mb-6 py-3 text-center max-w-md">
                        ...
                        >
                            00020126430014br.gov.bcb.pix0114+55489996940840203Pix5204000053039865406197.005802BR5917GERUSA LORENZETTI6013FLORIANOPOLIS62150511Despertar4063044D9C
                        </p>
                        {copySuccess && (
